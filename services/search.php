<?php
	...
	$where = array("nombreServicio" => $regex);
	...
	if(empty($cursor)) {
		...
		foreach ($cursor as $id => $value) {
			...
			echo '<td>';
			echo '<a class="btn" href="read.php?id='.$id.'&search='.$search.'">Consultar</a>';
			echo '&nbsp;';
			echo '<a class="btn btn-success" href="update.php?id='.$id.'&search='.$search.'">Actualizar</a>';
			echo '&nbsp;';
			echo '<a class="btn btn-danger" href="delete.php?id='.$id.'&search='.$search.'">Eliminar</a>';
			echo '</td>';
			echo '</tr>';
		}
		echo '<tr>';
